...
# 集合参数
parser.add_argument('--create_collect', action='store_true', default=False,
                    help='指定Milvus数据库是否的集合，默认是不创建')
...
parser.add_argument('-ef', '--extract_feature', action='store_true', default=False,
                    help='指定是否对数据集抽取特征，默认是不执行抽取操作')
